...
public class TestE {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			for (int i = 0; i < 1; i++) {
				...
				if (flag == 5) {
					// System.out.println("\n"+"1"+ksd.getUsername());
					writer.write("5" + ksd.getUsername() + "\n");
				} else {
					System.out.println("5" + ksd.getUsername()
							+ "=================" + flag);
					writer.write("5" + ksd.getUsername() + "================="
							+ flag + "\n");
				}
	...
	// 请款审批同意数据运营
		...
		public static boolean testSP2(WebDriver driver, String email, String itename,KSDCase ksd) {
			...
			WebUtil.df(driver,By.id("risk_type3")).click();
 
			WebUtil.df(driver,By.id("is_allReturn")).click();//全部
