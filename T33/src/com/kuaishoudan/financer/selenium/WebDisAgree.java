...
public class WebDisAgree {
	...
	public static void testDisAgreeQk(AppiumDriver<AndroidElement> driver,
			KSDCase ksd) {
		// driver.findElement(By.id("com.kuaishoudan.financer:id/text_name")).click();//
		driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
		driver.findElement(By.id("com.kuaishoudan.financer:id/text_name"))
				.click();
		try {
			Thread.sleep(2000);
		} catch (InterruptedException e) {
		...
		driver.findElement(By.id("com.kuaishoudan.financer:id/tv_record"))
				.click();
		driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
		driver.findElement(
	...
	public static boolean loginBD(AppiumDriver<AndroidElement> driver,
		...
		driver.findElement(
				...
				.click();// bu同意按钮
		driver.manage().timeouts().implicitlyWait(8, TimeUnit.SECONDS);
		driver.findElement(By.id("com.kuaishoudan.financer:id/edit_reason"))
				.sendKeys(
						"自2017年市行政审批局成立以来，我市持续加大简政放权力度。 截至目前， 行政审批许可事项由2017年的212项减少为117项，削减率近50%。2017年4月， 市行政审批局正式成立。一年来，该局以构建审批标准化为统领，以破解行政审批工作服务全局遇到的难点问题为导向，立足深化 “放管服”改革成效，为全市经济发展提供了更高效的审批、更优质的服务。加大简政放权力度。市行政审批局不断深化行政审批制度改革");
		driver.manage().timeouts().implicitlyWait(18, TimeUnit.SECONDS);
