...
public class Mgcc {
	...
	public   static void mgcGJBXX(AndroidDriver<WebElement> driver,KSDCase ksd){
		AppUtil.df(driver, By.id("com.kuaishoudan.mgccar:id/tv_toolbar_confirm")).click();
		AppUtil.df(driver, By.id("com.kuaishoudan.mgccar:id/edit_name")).sendKeys(ksd.getUsername());
		AppUtil.df(driver, By.id("com.kuaishoudan.mgccar:id/edit_phone")).sendKeys(ksd.getPhone());
		...
		if (ksd.getIdentitytype() == 1) {
			...
			// 点击军官证
			AppUtil.df(driver, By.id("com.kuaishoudan.mgccar:id/text_id_type")).click();//点身份证
			try {
				Thread.sleep(200);
			} catch (InterruptedException e) {
				// TODO Auto-generated catch block
	...
	public   static void mgcGCXX(AndroidDriver<WebElement> driver,KSDCase ksd){
		...
		if (ran == 1) {
			AppUtil.df(driver, By.id("com.kuaishoudan.mgccar:id/text_car_type")).click();//新车或二手车
			driver.findElements(
					By.id("com.kuaishoudan.financer:id/check_old_car")).get(1)
					.click();
			// 二手车
		}  
		AppUtil.df(driver, By.id("com.kuaishoudan.mgccar:id/text_brand")).click();
		
		AppUtil.df(driver, By.id("com.kuaishoudan.mgccar:id/text_brand")).click();
		AppUtil.df(driver, By.id("com.kuaishoudan.mgccar:id/text_series")).click();//车系
		try {
			Thread.sleep(200);
		} catch (InterruptedException e) {
			// TODO Auto-generated catch block
		...
		AppUtil.df(driver, By.id("com.kuaishoudan.mgccar:id/text_periods")).click();
		
		driver.findElements(By.id("com.kuaishoudan.mgccar:id/text_select")).get(ksd.getHkqs() ).click();//还款期数
		try {
			Thread.sleep(200);
		} catch (InterruptedException e) {
			// TODO Auto-generated catch block
		...
		AppUtil.df(driver,By.id("com.kuaishoudan.mgccar:id/edit_remark")).sendKeys(ksd.getRemark());//备注.
		int gq = ksd.getQygr();
		if( gq == 2  ){
		AppUtil.df(driver,By.id("com.kuaishoudan.mgccar:id/cb_main")).click();//企业进件
		AppUtil.df(driver,By.id("com.kuaishoudan.mgccar:id/edit_company_name")).sendKeys(ksd.getBusinessname());//企业名称.
		AppUtil.df(driver,By.id("com.kuaishoudan.mgccar:id/tv_company_no")).sendKeys(ksd.getBusinessid());//营业执照.
		}
